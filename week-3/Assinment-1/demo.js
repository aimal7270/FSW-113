...
for(i=0; i<items; i++){
    ...
    newFact.textContent = starwars_data[i].name
    document.body.append(newFact)

    var tall = document.createElement("li")
    tall.textContent = starwars_data[i].height
    document.body.append(tall)

    var weight = document.createElement("li")
    weight.textContent = starwars_data[i].mass
